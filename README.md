...
```bash
claude -p "Install TaskMaster: 1) Create .taskmaster/config.json with {\"models\":{\"main\":{\"provider\":\"claude-code\",\"modelId\":\"opus\"}}} 2) Add .taskmaster/ to .gitignore" && claude "/plugin marketplace add mike-coulbourn/claude-vibes"
```
