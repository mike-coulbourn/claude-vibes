...
- A specific file: `/01-assess src/api/search.ts`
- A directory: `/01-assess src/utils/`
- A concept: `/01-assess the authentication flow`"
...
- "Ready to refactor? Run `/02-refactor docs/refactor/assessment-<topic>.md` or describe what to tackle first"
...
- Save assessment for handoff to /02-refactor
...
5. Next step: "Run `/02-refactor` to start improving the code"
