...
> If **Push + Pull > Anxiety + Habit**, they'll switch.
> If not, the benefits aren't worth the perceived pain of change.
...
### The Limbic Map (Hans-Georg Hausel)
...
- What problem does the startup solve for them?
...
If not, identify:
- What additional push could be created (problem awareness)?
- What additional pull could be created (solution promise)?
- What anxieties must be addressed (trust signals)?
- What habits must be overcome (switching support)?
