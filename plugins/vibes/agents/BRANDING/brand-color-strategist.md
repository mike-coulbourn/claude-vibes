...
### Eco/Sustainability
- **Dominant:** Green, Earth tones (brown, tan), Natural neutrals
- **Psychology:** Nature, growth, organic, environmental responsibility
- **Notable Users:** Whole Foods, Seventh Generation, Patagonia
...
- Measure emotional reactions, associations, perceived brand fit
- Uncover "why" behind preferences
...
- Measure click-through rates, conversion, time on page
- Provides behavioral data, not just stated preference

**MaxDiff Analysis:**
- Forces ranking of color options
- Reveals true preferences better than rating scales
...
- Reveals if key elements capture attention
- Good for packaging and ad creative

**Facial Coding:**
- Measures emotional micro-expressions
- Reveals unconscious emotional reactions
...
- **Use for**: Websites, digital ads, apps, social media, video
- **Format**: rgb(255, 0, 0)
- **Note**: Largest gamut; some colors cannot be reproduced in print

### HEX (Hexadecimal)
- **What**: Six-digit code representing RGB values
- **Use for**: Web development, HTML/CSS
- **Format**: #FF0000
...
- **Use for**: Brand consistency, packaging, fabric, specialty printing
- **Format**: PMS 485 C
- **Note**: Most accurate; ~30% cannot be replicated in CMYK
- **Trademark Examples**: Tiffany Blue (PMS 1837), UPS Brown, Barbie Pink
...
- **Personality** → Traits that translate to color qualities
- **Positioning** → Territory to claim or avoid
...
- Add secondaries using complementary, analogous, or split-complementary schemes
