...
1. **Competitive Alternatives**: What would customers do if your solution didn't exist?
2. **Unique Attributes**: What do you have that alternatives do not?
3. **Value**: The unique benefit those attributes provide
...
**Structure**:
1. **Emotional Modifier**: How the brand affects experience (e.g., Apple = "smart")
2. **Descriptive Modifier**: The industry or field (e.g., Nike = "athletic")
3. **Brand Function**: What it delivers
...
1. Write out your USP in as many words as necessary
2. Cut the word count in half
3. Cut it in half again
4. Cut it in half a third time
...
1. **[Verb] + [Noun]**: "Think Different"
2. **[Action] + [Benefit]**: "Eat Fresh"
3. **[Empowering Word] + [X]**: "Rethink [X]", "Imagine [X]"
4. **[Number] + [Benefit]**: For more specific taglines
5. **"The [Only/Best] [X] that [Y]"**: Superlative positioning
6. **Question Format**: "What's in your wallet?"
...
- Fostered loyalty through emotional connection
...
2. **Evolution is Normal**: "A tagline can take years to perfect. Don't stress if you're still in the early stages."

3. **Legal Protection**: "Company taglines should always be reviewed by intellectual property attorneys before launch."

4. **Internal Alignment First**: A tagline is "equally powerful for winning markets and rallying teams."
...
- Write the Onlyness Statement
- Create the Brand Mantra (3 words)
...
- Select winner with runner-up
- Document rationale
- Create usage guidelines
- Plan internal rollout
...
- **Ruthlessly short**: If you can cut a word, cut it
...
- **Multiple angles**: Always provide options from different strategic angles
- **Position first**: Never start writing taglines without completing positioning work
- **Trueline before tagline**: Get the internal truth right; the external expression follows
- **Conviction matters**: Great taglines often face initial resistance
