...
- **Type has personality**: Every typeface has character traits that must match brand personality
- **Typography serves content**: Beautiful type that doesn't honor content fails
- **Hierarchy creates clarity**: Typography guides the eye and mind through information
- **Pairings require contrast**: Complementary typefaces work through meaningful difference
- **Legibility is fundamental**: Readability is non-negotiable; style cannot compromise it
- **Systems scale**: Typography must work across all applications and contexts
- **Accessibility is not optional**: 15-20% of population may have dyslexia; many more have visual impairments
- **Context matters**: Digital, print, and display have different requirements
...
1. **Define Brand Personality**: Identify 3-5 traits that define brand voice and image. These traits translate directly into typographic forms.

2. **Understand Target Audience**: Demographics, preferences, and expectations matter. Different industries favor specific font types ingrained in audience expectations.

3. **Gather Inspiration**: Analyze competitors, identify what works, determine how to differentiate.

4. **Select and Pair Fonts**: Create mockups for various use cases (print, web, mobile) to test if typefaces work in real applications.

5. **Establish Hierarchy**: Define primary, secondary, and tertiary fonts with clear purposes.

6. **Create Guidelines**: Document everything with relevant examples and specifications.
...
- Monospace can pair with any classification for technical accent
...
3. **Use `font-display: optional`** for maximum performance (font used only if cached)

4. **Match Fallback Metrics**: Tune fallback fonts to match web font dimensions, reducing layout shift
...
**Best Practices**:
- Use `rem` for min/max values (respects user zoom settings)
- Headings benefit most from fluid scaling
- Body text can use fixed sizes (less dramatic scaling needed)
- Adjust line height for different viewport sizes
- Test at zoom levels up to 200%
...
**Benefits**:
- Zero download time (instant render)
- No layout shifts
- Native look and feel per platform
- Already optimized for screen rendering
...
- Some fonts lack proper print weights
- Licensing may differ for print vs. web
...
|---------|-----------|----------------|
| [Pangram Pangram](https://pangrampangram.com/) | Contemporary, premium fonts | ~$40 |
| [TypeType](https://typetype.org/) | 75+ award-winning families | Varies |
| [Grilli Type](https://www.grillitype.com/) | Swiss foundry; Samsonite, Esquire | Varies |
| [Commercial Type](https://commercialtype.com/) | Google, Amazon, Intel | Premium |
...
| Tool | Purpose |
|------|---------|
| [Typescale.io](https://typescale.io/) | Generate modular type scales |
| [Type Scale Tool](https://precise-type.com/) | Calculate precise typography with CSS output |
| [Modern Font Stacks](https://modernfontstacks.com/) | System font stacks by classification |
| [WebAIM Contrast Checker](https://webaim.org/resources/contrastchecker/) | Verify accessibility compliance |
...
- **Voice** → How the brand sounds (type should match)
- **Archetype** → Emotional foundation for type choices
...
- Write usage guidelines (do's and don'ts)
- Specify cross-channel adaptations
...
### Presentations
Headlines: [Primary] at [size], [weight]
...
| Email | [Fallback to system] | [Fallback to system] | Web fonts unreliable |
| Print | [Full font] | [Full font] | Adjust sizes for 300dpi |
...
**Modular Scale**: [Typescale.io](https://typescale.io/)
**Contrast Checker**: [WebAIM](https://webaim.org/resources/contrastchecker/)
**System Font Stacks**: [Modern Font Stacks](https://modernfontstacks.com/)
**Font Source**: [Google Fonts](https://fonts.google.com/) | [Specific foundry links]
```
