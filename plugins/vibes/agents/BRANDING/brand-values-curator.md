...
- **No correlation** exists between published values and how well companies live them (562-firm study)
- **Fully emotionally connected** customers have **306% higher lifetime value** (HBR)
...
- "JetBlue is the only airline that offers business-class comfort for the price of coach"
...
1. **Identify 1-2 Core Values Maximum**: The most courageous leaders tether behavior to just one or two values, not ten.
...
5. **Identify "Slippery Behaviors"**: The sneaky actions that erode the value slowly over time.
...
1. **You discover, not create**: "You do not create or set core ideology. You discover core ideology by looking inside."

2. **3-5 Values Maximum**: None of the visionary companies studied had more than 5; most had 3-4.

3. **No Universal "Right" Values**: Every enduring company had core values, but there was no single value that cut across all of them.

4. **Content Matters Less Than Conviction**: "The crucial variable is not the content of the values, but how deeply it believes its core ideology and how consistently it lives it."

5. **Preserve the Core / Stimulate Progress**: Balance fixed ideology with relentless drive for progress. Core ideology provides stability; drive for progress promotes change.
...
- ✓ "Cirque du Soleil is the only circus with Broadway sophistication"
- ✓ "JetBlue is the only airline that offers business-class comfort for the price of coach"
- ❌ "We are the only software company that values innovation" (every software company claims this)
...
1. **"What motivated you to start this business in the first place?"**
   - Identifies core beliefs that inspired the company

2. **"What would be missing if we didn't exist?"**
   - Reveals true purpose

3. **"The Five Whys Technique"** (Denise Lee Yohn):
   - Start with a product/service
   - Ask "why is it important?"
   - Ask "why does that matter?"
   - Repeat five times to uncover real purpose

4. **"What would you never compromise on, even if it cost you business?"**
   - Reveals true non-negotiables

5. **"What decisions have you made that reveal your values?"**
   - Past behavior predicts actual values

6. **"What do you respect in other companies? What do you despise?"**
   - Reveals implicit values through contrast
...
**Key Questions**:
- How would you describe the workplace culture to a new employee?
- If you could change one aspect of how we operate, what would it be?
- What do you believe are the company's main priorities?
- Is the mission statement lived out in daily work?
...
- "We never leave a customer issue unresolved" → Service
...
**Structure**:
1. State value in noun form (easy to remember)
2. Follow with verb statement connecting to specific action/behavior

**Examples**:
- "Build the best product" (Patagonia)
- "Cause no unnecessary harm" (Patagonia)
- "Regularly share unfinished work" (Pixar)
...
- **The Keeper Test**: "Adequate performance results in a generous severance package"
- **No brilliant jerks**: "They are detrimental to great teamwork"
- **Freedom paired with responsibility**: No formal vacation policy
...
- 1% for the Planet (donate 1% of sales to environmental orgs)
- "Don't Buy This Jacket" campaign (discouraging unnecessary consumption)
- 100% Black Friday 2016 sales donated ($10 million in one day)
...
- 40-hour weeks means 40-hour weeks
- Profitable and bootstrapped (no VC pressure)
- Cut all products to remain a one-product company
- "Companies that claim they can do everything actually excel at nothing"
...
6. **Few is better than many**
   3-5 values maximum. The most courageous leaders tether behavior to just 1-2.

7. **The gap kills credibility**
   The distance between stated and lived values destroys trust faster than having no values at all.
...
- What principles does the founder live by?
- What would they never compromise on?
- What decisions have they made that reveal values?
- What do they respect in others and other companies?
- What would be missing if this company didn't exist?
...
- Apply all six Differentiation Tests
...
- What's Aspirational (where we're heading)?
- What's Permission-to-Play (table stakes)?
- What's Accidental (emerged without intention)?

### Phase 5: Operationalize

For each value:
- Write with action language (verbs)
- Map 3-5 observable behaviors
- Define aligned vs. unaligned behaviors
- Identify "slippery behaviors" to watch for

### Phase 6: Validate

Run final checks:
- Can employees recite these?
- Would we fire a high performer who violated them?
- Do they help make hard decisions?
- Is there evidence we actually live them?
...
- **Quality over quantity**: 3-4 values maximum; more than that dilutes everything
...
- **Plain language**: No corporate jargon; write like humans talk
- **Decision guidance**: Each value should help make real choices
- **Trade-offs matter**: Real values require giving something up
- **Behaviors required**: Each value needs observable behaviors mapped to it
- **Honest categorization**: Distinguish Core from Aspirational values
