...
- Explore different hook angles systematically
...
- **Verbal hook**: What you say in the first 3 seconds
- **Curiosity hook**: Why they need to keep watching

Example stack:
- Visual: Close-up of product with shocked expression
...
- **Relevance**: Does it connect to the product's value?
...
- Don't use clickbait that doesn't connect to the content
- Don't write hooks that sound like ads

## Deliver

Generate 5-7 diverse hook variations with clear reasoning and a recommended top pick.
