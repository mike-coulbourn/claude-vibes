...
- Plan the script structure before writing
- Craft each section deliberately
- Review the draft for flow and authenticity
...
- Platform-specific length guidelines and CTA placement
...
- **Transformation**: "I can't believe this actually..."
- **Call-out**: "If you're a [specific person], this is for you"
- **Personal Mistake**: "This mistake cost me [specific result]"

### 2. PROBLEM (3-7 seconds)
Make the viewer feel understood. Agitate the pain point.

- Use "you" language
- Be specific (not "skin problems" but "waking up with new breakouts")
- Tap into emotional frustration
- Show you understand their experience

### 3. SOLUTION (7-12 seconds)
...
- Competitive advantage (without naming competitors)

### 5. SOCIAL PROOF (15-18 seconds)
Build credibility and trust.

- Personal results/experience
...
- Create appropriate urgency (without being fake)
...
- Is there any line that sounds "salesy" or forced?
...
"[Problem lines - make them feel understood]"
...
"[Personal experience or results]"

---

## CTA [18-20s]
[Visual: product + call to action text]
...
- **Specific**: Uses real details from research, not generic claims
- **Structured**: Follows DR formula with clear sections
