...
- **Efficiency**: Teams spend less time debating and more time executing when there's a shared framework
...
*This is bragging, and prospects are skeptical of bragging.*
...
- **Core Identity** (2-5 elements): Essential, stable over time, drives programs
- **Extended Identity** (3-5 elements): Adds richness and texture

**Three Types of Benefits (Aaker's Value Proposition):**
1. **Functional Benefits**: What the product DOES
2. **Emotional Benefits**: How it makes customers FEEL
3. **Self-Expressive Benefits**: What it SAYS about the customer
...
**Core Message:** "Bring inspiration to every athlete in the world" (with the belief that "if you have a body, you are an athlete")
**How it shows up:** Every ad, product, and partnership reinforces these pillars. "Just Do It" encapsulates aspiration in three words.
...
**How it shows up:** Recycled materials, repair programs, environmental grants, "Don't Buy This Jacket" campaign. Mission permeates everything.
...
5. Document in accessible framework
...
- [ ] 3-4 messaging pillars identified
- [ ] 3+ proof points per pillar documented
- [ ] Brand voice and tone defined
- [ ] Elevator pitch (30-second version) written
- [ ] Target audience clearly defined
- [ ] Message Layers assessment completed
- [ ] MECLABS quality tests passed
- [ ] Messages tested with real customers
...
- **Test with real customers**: What sounds good internally may not resonate externally
