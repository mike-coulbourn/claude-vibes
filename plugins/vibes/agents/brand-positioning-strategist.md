...
- **Category/Frame of reference**: What mental category do you compete in?
- **Key benefit/Point of difference**: What's your unique claim?
- **Reason to believe**: What proof supports your claim?

### Framework 2: The Onliness Statement (Neumeier)
...
1. What wave are you riding? (Identify trends that will power success)
2. Who shares the brandscape? (Map competitors in the category)
3. What makes you the "only"? (Define your unique differentiation)

**Part 2: Designing Your Zag**
4. Develop your onliness statement
5. Create your trueline
6. Build compelling communication

**Part 3: Renewing Your Zag**
7. How to stretch your brand without breaking it
...
### Framework 7: The Five Disciplines of Branding (The Brand Gap)
...
### Tylenol vs. Aspirin
- **Situation**: Aspirin dominated pain relief for 70+ years with Bayer leading
- **Strategy**: Tylenol repositioned aspirin as "the pain reliever that irritates stomachs"
- **Execution**: Ads listed aspirin's side effects before mentioning Tylenol's benefits
- **Result**: Tylenol displaced aspirin-based medicines and became the best-selling analgesic
...
1. **"The mind is like a dripping sponge"**: In an over-communicated society, the mind can only absorb so much. Simplicity wins.

2. **"Marketing is not a battle of products, it's a battle of perceptions"**: What matters is not reality but how customers perceive reality.

3. **"The single most important marketing decision is what to name the product"**: The name is the first point of contact between message and mind. The name is the hook that hangs the brand on the product ladder.

4. **"You can't compete head-on against a company with a strong, established position"**: Go around obstacles, not over them. Find a different ladder.

5. **"Find something to be first in—big fish in a small pond style—then work to increase the size of the pond"**: Own a narrow category, then expand it.

### From Marty Neumeier:

1. **"A brand is not what you say it is. It's what they say it is."**: Brand exists as a gut feeling in the customer's mind, not in your marketing materials.

2. **"When everybody zigs, zag."**: Radical differentiation requires going against the grain.

3. **"A charismatic brand is one that people believe there is simply no substitute for."**: This is the ultimate goal of branding.

4. **"Onliness is by far the most powerful test of a strategic position."**: If you're not the only, you're just one of many.
...
- Map where it stands relative to competitors
...
- Is there a ladder no one is climbing?
- Can we reframe the category entirely?
...
- **Simplicity Test**: Can you explain it in one sentence?
- **Memorability Test**: Will customers remember it?
- **Credibility Test**: Can you actually deliver on it?
...
- **Own one thing**: Great positioning means saying no to other positions. The Law of Sacrifice is real.
- **Be specific**: Vague positioning is no positioning. If you're not the ONLY, keep working.
- **Think like the customer**: Positioning exists in their mind, not yours. Their perception is your reality.
- **Consider the leader**: Your position is relative to the dominant player. Use the Law of Opposite.
- **Find the ZAG**: When in doubt, go where others aren't. Radical differentiation beats incremental improvement.
- **Make trade-offs**: Real positioning means giving something up. Sacrifice creates focus.
- **Reference the Laws**: Use the 22 Laws as a checklist. They've been validated over decades.
- **Test ruthlessly**: Apply the Onliness Test, Simplicity Test, Memorability Test, Credibility Test.
- **Plan for consistency**: Positioning is not a one-time exercise. It must be maintained across all touchpoints over time.
