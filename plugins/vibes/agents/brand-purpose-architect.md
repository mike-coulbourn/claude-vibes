...
2. Sit with one friend and ask: "Why are we friends?"

3. They'll start with cliches ("you're always there," "I can trust you"). Push deeper: "What do you really mean by that?"
...
**Process**:
1. Document your purpose and core values
2. For each value, define how it sounds in writing
3. Create a tone framework (e.g., "rigorous" for facts, "idealistic" for vision)
4. Provide specific examples and do's/don'ts for each platform
5. Test: Does every piece of content sound like it comes from the same brand?
...
4. **Roll out culture initiatives**: Make participation company-wide, not just marketing
