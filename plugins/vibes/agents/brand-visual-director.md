...
- **33%** revenue improvement from consistent color use
- **23%** higher revenue growth for companies using strategic identity frameworks
...
Start with brand name in center, branch for different ideas. Goal: see patterns emerge on one page.

**Step 3: Visual Word Translation**
Translate each adjective into visual direction:
...
- **Archetypes have visual languages**: Each archetype expresses differently
- **Differentiation matters**: Visuals must stand out from competitors
- **Systems scale**: Visual identity must work across all applications
- **Simplicity endures**: The best visual identities are elegantly simple
- **Mood boards before design**: Align on direction before detailed work
...
**Props & Styling:**
- Style and material of all props
- Styling arrangements and setups
- What to include/exclude

**Color Treatment:**
- Primary and secondary brand colors in photography
...
- [Notion Brand](https://www.notion.so/about)
