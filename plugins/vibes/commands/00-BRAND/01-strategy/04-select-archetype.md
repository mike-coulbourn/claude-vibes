...
**CRITICAL: You MUST use the Agent tool to launch the brand-archetype-selector agent.** Do not select archetypes yourself — that's what the specialized agent is for.
