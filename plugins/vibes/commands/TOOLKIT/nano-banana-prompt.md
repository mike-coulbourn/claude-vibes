...
argument-hint: What you want to create, optionally with reference images (e.g., "[image] make this character in different poses")
---
...
**Round 2: style and mood** (if not already clear)
...
**Round 4: reference images and consistency**

**If images were provided with the request:**

Skip the "do you have references?" question, because you already have them. Instead, confirm your analysis and ask about intended use:
...
**For storyboards and sequential art:**
- Panel count: [NUMBER]
...
- Lighting matters: soft, dramatic, natural
